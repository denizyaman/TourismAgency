İki tane user tipi olan bir acente sisteminde, admin kullanıcısının kullanıcıları yönettiği, user kullanıcısının anlaşmalı otelleri ve özelliklerini yöneterek 
